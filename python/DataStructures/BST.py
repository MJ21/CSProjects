...
class TreeNode:
  ...
  def __iter__(self): #in order iteration
    if self:
      if self.hasLeftChild():
...
class BinarySearchTree:
  ...
  def remove(self,currentNode):
    ...
    elif currentNode.hasBothChildren(): #interior has both children
...
def postorder(tree):
  if tree:
    postorder(tree.hasLeftChild())
    postorder(tree.hasRightChild())
    print(tree.key)
...
print "length %i " % t.length()

for key in t:
  print "key: %i , value: %s" % (key, t[key])
print " "
